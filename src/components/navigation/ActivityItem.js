      ...
      <Menu.Item>
        {({ active }) => (
          <button
            className={`${
              active && "bg-blue-50"
            } group flex justify-between rounded-md items-start w-full px-4 py-2.5 text-sm duration-200`}
          >
            <div className="flex space-x-5 items-center">
              ...
              <div className="flex flex-col justify-between space-y-1 items-start">
                <h2 className="text-base font-medium">Agatha Chelsea</h2>
                <p className="text-sm text-minor-text">You're mentioned in this comment</p>
              </div>
            </div>
